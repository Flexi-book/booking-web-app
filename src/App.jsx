...
function PageLoader() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950">
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="w-10 h-10 border-2 border-blue-600 border-t-transparent rounded-full animate-spin" />
        <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Cargando vista...</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen w-full min-w-0">
        {/* Header */}
        <header className="bg-white border-b border-slate-200 sticky top-0 z-10 dark:border-slate-800 dark:bg-slate-950">
          <div className="px-4 lg:px-6 py-3.5 flex items-center justify-between gap-4">
            {/* Menu Mobile */}
            <button 
              className="lg:hidden p-2 -ml-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-slate-700 transition dark:text-slate-400 dark:hover:bg-slate-900 dark:hover:text-slate-100"
            ...
            <div className="flex-1 max-w-sm relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg
                           ...
                           dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:bg-slate-900"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              <ThemeToggle />
              <button className="relative p-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-slate-700 transition dark:text-slate-400 dark:hover:bg-slate-900 dark:hover:text-slate-100">
